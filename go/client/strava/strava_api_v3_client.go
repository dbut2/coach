...
import (
	...
	"naomi.run/client/strava/activities"
	"naomi.run/client/strava/athletes"
	"naomi.run/client/strava/clubs"
	"naomi.run/client/strava/gears"
	"naomi.run/client/strava/routes"
	"naomi.run/client/strava/segment_efforts"
	"naomi.run/client/strava/segments"
	"naomi.run/client/strava/streams"
	"naomi.run/client/strava/uploads"
)
...
func New(transport runtime.ContextualTransport, formats strfmt.Registry) *StravaAPIV3 {
	// ensure nullable parameters have default
	if formats == nil {
...
func (c *StravaAPIV3) SetTransport(transport runtime.ContextualTransport) {
